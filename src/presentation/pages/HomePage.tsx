...
import { FaUserPlus, FaIdCard, FaShieldAlt, FaUsers, FaArrowRight, FaBars, FaTimes, FaPlayCircle } from 'react-icons/fa';
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            ...
                            <Link to="/tutorial" className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 bg-white/5 border border-white/10 text-white font-bold rounded-2xl hover:bg-white/10 transition-all backdrop-blur-md">
                                <FaPlayCircle className="text-brand" /> Watch video
                            </Link>
                        </div>
                    </motion.div>
                </div>
